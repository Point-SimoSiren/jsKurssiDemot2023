...
//Seuraavaa rutiinia kutsutaan aina, kun käyttäjä kirjoittaa jotain ja/tai
//painaa enteriä
...
process.exit();
} else //Muussa tapauksessa lasketaan yhteen lukujen summia annetun
//laskukaavan perusteella
{
kaava = data.trim()
try {
    tulos = eval(kaava);
    ...
    console.log("Virheellinen kaava. Lue lisää: " + err
    )
}
